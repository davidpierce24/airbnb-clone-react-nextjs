  ...
  return (
    <div className="">
      <Head>
        ...
        <meta name="google-site-verification" content="IhzVDtAQuHgOVs4UVep2pCeLMPL1M9FS6unj-9YXAkA" />
      ...
      <main className='max-w-7xl mx-auto px-8 sm:px-16'>
        <section className='pt-6'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
            {dataNearby?.map(({ img, location, distance }) => (
